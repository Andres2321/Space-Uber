  ...
  return (
    <>
      <div className='grid-container'>
        ...
        This is the service for you. Just click on the 'Find Planets' button below.</p>
        ...
        <p className='home-par2'>We currently only offer travel to 16 planets.
          If you know the right guy you might be able to do some interdimensional traveling,
          at the right price, of course. Let's just say it's not exactly legal yet.</p>
        ...
        <img src='https://i.imgur.com/cu4uZWm.png' className='home-img4' alt='Rick' />
      </div>
      <Footer />
    </>
  )
